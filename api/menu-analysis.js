...
function buildSearchQuery(restaurantInfo) {
...
function parseMenuResponse(content, restaurantInfo) {
  try {
...
function isReasonableDishName(name, cuisineType) {
...
function extractDescriptionFromContext(content, dishName) {
  if (!content || typeof content !== 'string') {
    return undefined;
  }
...
function extractCategoryFromContext(content, dishName) {
  if (!content || typeof content !== 'string') {
    return null;
  }
